...
## 🧭 Overview
This project spins up a raw TCP listener with `node:net`, consumes socket data line-by-line, and validates HTTP/1.1 request lines without frameworks or third-party helpers. It serves as a learning playground for dissecting the HTTP protocol while enjoying TypeScript’s safety guarantees.
